...
export const formInputUnderlineClass =
  'w-full border-0 border-b border-[var(--color-form-border)] bg-transparent py-2.5 text-base font-light leading-[0.9] tracking-[-0.04em] text-ink outline-none placeholder:text-[var(--color-form-placeholder)] focus:border-ink/50'
